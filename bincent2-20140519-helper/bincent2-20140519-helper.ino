...
int xRefill[4] = {1000,3000,5800,8300}; // refill location

// poses

int servo_park[INC_SIZE] = {2930,2950,2920,2920,2950};

int paint0[INC_SIZE] = {2950,1800,3000,2700,3500};
int paint1[INC_SIZE] = {2950,1450,4700,2200,3950};
int paint2[INC_SIZE] = {2950,1450,4700,2200,4700};

int armRefill0[INC_SIZE] = {2950,2950,2950,1950,1700};
int armRefill1[INC_SIZE] = {2950,2950,2950,1700,1450};
int armRefill2[INC_SIZE] = {2950,2450,3200,1700,1450};
int armRefill3[INC_SIZE] = {2950,2200,3200,1700,1450};
...
void loop() {
	...
	cycleCount++;
	while(cycleCount > 666) { // stop working
		Serial.println("the art is done.");
		delay(10000);
	}

	rToss = toss(); // will it refill?
