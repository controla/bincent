...
int armRefill2[INC_SIZE] = {2930,2200,2800,2920,1300};
int armRefill3[INC_SIZE] = {2930,2000,2900,2920,1300};
...
void refill(int xPos) {
	...
	delay(5000);
	Serial.println("refill5");
	servoPose(armRefill5);
	delay(5000);
	Serial.println("refill6");
