...
#define X_OFFSET 400
#define Y_OFFSET 5000

#define INC_SIZE 5 // using this?
#define X_REF_SIZE 7
...
void setup() {
	...
	Serial.println("");
	Serial.println("*************************");
	Serial.println("**** Bin¢ent II v0.4 ****");
	Serial.println("*************************");
...
void loop() {
	...
	for(int y = Y_OFFSET; y < Y_LEN; y+=random(100)+50) { // advance Y axis in 50 increments for each row
		yStepper.moveTo(y);
